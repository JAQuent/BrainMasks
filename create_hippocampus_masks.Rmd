...
In this subdivision, the hippocampi are divided into anterior and posterior based on the dividing line of y = -21 mm (MNI) with everything "at or anterior to" that being the anterior hippocampus. This should be relatively easy to do with `ciftiTools`. 
